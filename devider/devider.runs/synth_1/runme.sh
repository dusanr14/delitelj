...
HD_PWD='C:/Users/Dusan/Desktop/8_semestar/system_level/devider/devider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Division.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Division.tcl
